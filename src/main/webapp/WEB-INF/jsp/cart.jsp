					...
					<form method="POST" modelAttribute="paymentModel" action="/payment">
						...
						<div class="form-row">
							<div class="col-md-8 mb-3">
								<label for="userName">Name: ${request.userName}</label> <br>

								<label for="componentName">Component Name:
									${request.componentName}</label> <br> <label for="componentType">Component
									Type: ${request.componentType} </label> <br> <label
									...
									${request.contactNumber}</label> <br> <label for="dateOfDelivery">DateOfDelivery:
									${response.dateOfDelivery}</label> <br> <label
									for="isPriorityRequest">IsPriorityRequest:
									${request.isPriorityRequest}</label> <br> <label for="cardLimit">CardLimit:
									${request.cardLimit} </label> <br> <label for="quantity">Quantity:${request.quantity}
								</label><br>
							</div>
						</div>
						...
						<!-- Alldiv ends -->
						<h2>${error}</h2>
						<%-- <h1 class="displa  y-8 text-info">hi ${payment.status}</h1>--%>
