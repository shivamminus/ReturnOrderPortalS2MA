                    ...
                    <form method="GET">
                        ...
                        <div class="form-row">
                            <div class="col-md-8 mb-3">
                                <label for="userName">Name: ${orderModel.userName}</label> <br>
                                <label for="componentName">Component Name: ${orderModel.componentName}</label>  <br>
                                <label for="componentType">Component Type: ${orderModel.componentType} </label>  <br>
                                ...
                                <label for="contactNumber">ContactNumber: ${orderModel.contactNumber}</label>  <br>
                                <label for="dateOfDelivery">DateOfDelivery: ${response.dateOfDelivery}</label>  <br>
                                <label for="isPriorityRequest">IsPriorityRequest: ${orderModel.isPriorityRequest}</label> <br>
                                <label for="cardLimit">CardLimit: ${orderModel.cardLimit} </label> <br>
                                <label for="quantity">Quantity:${orderModel.quantity} </label><br>
                            </div>
                        </div>
